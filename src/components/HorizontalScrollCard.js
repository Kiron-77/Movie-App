...
const HorizontalScrollCard = ({ data = [], heading, trending, media_type }) => {
    ...
    return (<>
        <div className='container mx-auto px-3 py-10'>
            <h2 className='text-lg:text-2xl font-bold mb-2 text-white capitalize'>{heading}</h2>
            <div className=' relative'>
                <div ref={containerRef} className='grid grid-cols-[repeat(auto-fit,230px)] grid-flow-col overflow-hidden gap-7 overflow-x-scroll relative z-10 scroll-smooth transition-all scrolbar-none'>
